...
INTRODUCTION = [
    "You are given one image with object placeholders and reference-object viewpoint context.",
]

STEM = [
    "Describe the allocentric relation between [A] and [B].",
]
...
register_oe(
    template_id="allocentric_relation.open_ended",
