"""Templates for scene_caption task."""
...
INTRODUCTION = [
    "You are given one image from an annotated scene.",
]

STEM = [
    "Describe the scene content and major entities using placeholders where appropriate: [SCENE].",
]
...
register_oe(
    template_id="scene_caption.open_ended",
